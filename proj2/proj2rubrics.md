...
[CSC 510 - Project 2 - Repo Presentation](https://youtu.be/8XT07zayAqI)
...
Use of version control tools |3| https://github.com/prateeksingamsetty/Simplii |
Use of style checkers |3| https://github.com/prateeksingamsetty/Simplii/blob/main/.github/workflows/style_checker.yml |
Use of code formatters. |3| https://github.com/prateeksingamsetty/Simplii/blob/main/.github/workflows/pylint.yml |
Use of syntax checkers. |3| https://github.com/prateeksingamsetty/Simplii/blob/main/.github/workflows/pylint.yml |
Use of code coverage |3| https://github.com/prateeksingamsetty/Simplii/blob/main/.github/workflows/code_cov.yml |
Other automated analysis tools |3| https://github.com/prateeksingamsetty/Simplii/actions  |
Test cases exist |3| https://github.com/prateeksingamsetty/Simplii/blob/main/tests/test_cli.py |
Test cases are routinely executed |3| https://github.com/prateeksingamsetty/Simplii/actions  |
The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up |3| https://github.com/prateeksingamsetty/Simplii/blob/main/CONTRIBUTING.md |
Issues are discussed before they are closed |3| https://github.com/prateeksingamsetty/Simplii/issues |
Chat channel: exists |3| https://github.com/prateeksingamsetty/Simplii#chat-channel |
Test cases: a large proportion of the issues related to handling failing cases. |3| https://github.com/prateeksingamsetty/Simplii/issues |
Evidence that the whole team is using the same tools: everyone can get to all tools and files |3| https://github.com/prateeksingamsetty/Simplii/graphs/contributors |
